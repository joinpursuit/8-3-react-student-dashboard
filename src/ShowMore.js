...
console.log("ShowMore Function was called!")
 const { current, goal } = props.stuObject.codewars;
     const { resume, linkedin, github, mockInterview } = props.stuObject.certifications;
     const { assignments, projects, assessments } = props.stuObject.cohort.scores;
